// ignore_for_file: non_constant_identifier_names, prefer_const_constructors, unnecessary_null_comparison, prefer_if_null_operators
...
class _OrderStatusState extends State<OrderStatus>
  ...
  // String deliveryLocationUrl = 'http://google.com';
  // //'http://google.com';
  // String googleMap_deliveryLocationUrl = '';
  ...
  void initState() {
    ...
    // if (deliveryLocationUrl.isNotEmpty) {
    ...
    //           setState(() {
    //             final innerString =
    //                 RegExp(r'/@(.*)/').firstMatch(url)?.group(1);
    //             latlong = innerString!.split(',');
    //             print('Lat${double.parse(latlong[0])}');
    ...
    //       onPageFinished: (url) {
    //         setState(() {
    //           googleMap_deliveryLocationUrl = url;
    //           print(googleMap_deliveryLocationUrl);
    //         });
    //       },
    //     ))
    //     ..loadRequest(
    //       Uri.parse(deliveryLocationUrl),
    //     );
    // }
  }
  ...
  // void Restrict_LogDeliveryLocation() {

  //    final innerString = RegExp(r'/@(.*)/').firstMatch(controller2)?.group(1);
  // }
  ...
  Widget build(BuildContext context) {
    ...
    // if (deliveryLocationUrl.isNotEmpty) {
    //   print('Distance is ${Geolocator.distanceBetween(
    //     locationProvider.currentLocation.latitude!.toDouble(),
    //     locationProvider.currentLocation.longitude!.toDouble(),
    //     double.parse(
    //         latlong[0].isEmpty ? '0.0' : latlong[0]),
    //     double.parse(
    //         latlong[1] == null || latlong[0].isEmpty ? '0.0' : latlong[1]),
    //   )}');
    // }

    //widget.onPressDelivered();
    //print('Lattt is ${latlong[0]}');
    // print('Lng is ${locationProvider.currentLocation.longitude}');
    ...
    if (isDataLoaded) {
      return Column(
        children: [
          ...
          //       print('Lattt${double.parse(lat[0])}');
          //       print('longgg${lat[1]}');
          //       //Get.back();
          //     },
          //     // onPageFinished: (url) {
                                ...
                                return OrderStatusContainer(
                                  ...
                                  onPressLocation: () {
                                    if (pendingOrdersData[i]['LocationLink'] !=
                                        null) {
                                      Functions.openGoogleMap(context,
                                          pendingOrdersData[i]['LocationLink']
                                          // .toString()
                                          );
                                    } else {
