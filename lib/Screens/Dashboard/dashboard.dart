// ignore_for_file: unused_field, unused_local_variable, non_constant_identifier_names, avoid_print, unused_element, prefer_const_constructors, unnecessary_brace_in_string_interps
...
import '../../OrderTicket/BottomBarItems/ticketDetails.dart';
...
class _DashboardState extends State<Dashboard> {
  ...
  Future<void> notificationList() async {
    ...
    pref.setString('notifcations', encode!);
    print('Addedd');
  }
    ...
    FirebaseMessaging.instance.getInitialMessage().then(
      (message) {
        ...
        if (message != null) {
          ...
          if (message.data['TaskRegisterDetailId'] != null) {
            Navigator.of(context).push(
              MaterialPageRoute(
                builder: (context) => TicketDetails(
                  ...
                  TaskRegisterId: message.data["TaskRegisterId"],
                ),
              ),
            );
          }
      ...
      (message) {
        ...
        if (message.notification != null) {
          ...
          setState(() {
            notifications.add(message.data);
            print(notifications);
            encode = json.encode(notifications);
            print('Encode is ${encode}');
            // Map map = notifications.asMap();
            // print('Map is  ${map}' );
          ...
          if (message.data['TaskRegisterDetailId'] != null) {
            ...
            //       isTaskRegister: true,
            //       priority: '',
            //       jobdescription: message.notification!.title,
            //       taskregisterid: message.data['TaskRegisterId'],
            //       taskregisterdetailid: message.data['TaskRegisterDetailId'],
            //       // taskregisterid: message.data['TaskRegisterDetailId'],
            //       // taskregisterdetailid: message.data['TaskRegisterId'],
            //       priorityclr: null,
            //     ),
            //   ),
            // );
    ...
    FirebaseMessaging.onMessageOpenedApp.listen(
      (message) {
        ...
        if (message.notification != null) {
          print(message.notification!.title);
          print(message.notification!.body);
          print("message.data22 ${message.data['TaskRegisterDetailId']}");
          setState(() {
            notifications.add(message.data);
            print(notifications);
            print(notifications.length);
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    //             builder: (context) => OpenTicketDuplicate(
                    //                 ActivityStatusId: '',
                    //                 PriorityId: '',
                    //                 TaskTypeId: '',
                    //                 ActvityStatus: ''),
