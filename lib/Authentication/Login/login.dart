// ignore_for_file: use_build_context_synchronously, unnecessary_brace_in_string_interps, avoid_print, unused_local_variable, non_constant_identifier_names
...
class _LoginState extends State<Login> {
  ...
  String? deviceToken;
  _userIdAppKeyRetriever() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();

    setState(() {
      _loginIdController.text = prefs.getString('UserId') ?? '';
      _appKeyController.text = prefs.getString('appKeyForLogin') ?? '';
    });
  }
  ...
  Future<void> subscribeUser() async {
    ...
    String url =
        '${prefs.getString('ApiUrl')}/TSBE/TaskRegister/InsertDeviceIdForSubscription?UserId=${userMap['UserId']}&DeviceId=${deviceToken}';
    ...
    if (response.statusCode == 200) {
      ...
      print('User Subscribe  Successfully');
    } else {
          ...
          children: [
                                ...
                                return AnimatedOpacity(
                                  ...
                                  child: const Padding(
                                    padding: EdgeInsets.only(
                                        top: AppConst.appMainPaddingExtraSmall),
                                    child: Center(
                                      child: Text(
                          ...
                          return AnimatedOpacity(
                            ...
                            child: Padding(
                              padding: const EdgeInsets.only(
                                  bottom: AppConst.appMainPaddingExtraSmall),
                              child: Image.asset(
            ...
            Column(
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.symmetric(
                      horizontal: AppConst.appMainPaddingLarge),
                  child: Column(
                    children: [
                      // Login Id Text Field
                      TweenAnimationBuilder(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: const InputDecoration(
                                    ...
                                    hintStyle: TextStyle(
                                      ...
                                      fontWeight:
                                          AppConst.appTextHintFontWeight,
                                    ),
                                  ),
                              ...
                              child: Padding(
                                ...
                                child: AppLargeButton(
                                  ...
                                  onPressedFunc: () async {
                                    ...
                                    try {
                                      if (_loginIdController.value.text
                                              .trim()
                                              .isNotEmpty &&
                                          _passwordController.value.text
                                              .trim()
                                              .isNotEmpty &&
                                          _appKeyController.value.text
                                              .trim()
                                              .isNotEmpty) {
                                        dynamic result =
