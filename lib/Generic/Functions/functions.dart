...
class Functions {
  ...
  static DateTime getTwelveMonthsDateTime(DateTime date) {
    ...
    if (countPreviousYear != 0) {
      ...
      return DateTime.parse(
          '${date.year}-${Functions.getMonthNumber(12 - countThisYear)}-01T00:00:00');
    }
  }
  ...
  static String getThreeEndMonth(int month) {
    ...
    var m = month - (numberOfMonthsBack - 1);
    var m2 = m < 0 ? 12 + m : m;
  ...
  static ShowSnackBar(BuildContext context, String content) {
    final snackBar = showToast(content,
        context: context,
