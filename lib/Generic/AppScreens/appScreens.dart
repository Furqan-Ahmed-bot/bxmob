...
class AppScreens {
  ...
  static Map<String, dynamic> screenIcons = {
    'Dashboard' : const Icon(Icons.dashboard , size: 20,),
    'MarkAttendanceNew' : const Icon(Icons.fact_check_rounded , size: 20),
    'TimeAndAttendance' : const Icon(Icons.calendar_today_rounded , size: 20),
    'OrderDeliveryStatus' : const Icon(Icons.calendar_today_rounded , size: 20 ,),
    'EmployeePayroll' : const Icon(Icons.payments_rounded , size: 20),
    'settings' : const Icon(Icons.settings , size: 20)
  };
