...
class OrderStatusService {
  static Future<ApiResponse> getRestaurantOrderStatus(
      List<Map<String, String>> filterList) async {
  ...
  static Future<ApiResponse> postRestaurantOrderStatus(
    List<Map<String, String>> filterList,
  ) async {
    //restrict_log actual delivery location
  ...
  static Future<ApiResponse> getOrderDetails(
      Map<String, dynamic> filterList) async {
    final response = await GenericService.getData(
