...
class AttendanceService {
  ...
  static Future<ApiResponse> getEmployeeAttendanceHistory(
      Map<String, String> filterList) async {
    final response = await GenericService.getData(
  ...
  static Future<ApiResponse> getEmployeeAttendanceSummary(
      Map<String, String> filterList) async {
    final response = await GenericService.getData(
  ...
  static Future<ApiResponse> saveAttendanceRecord(
      Map<String, String> filterList) async {
    final response = await GenericService.getData(
